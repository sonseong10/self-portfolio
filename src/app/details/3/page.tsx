...
import { contents, gradientTitle, layout, outLink } from "../1/work.css";
        ...
        <article>
          ...
          <ol>
            <li>
              ...
              <p>
                초기에는 표현 계층과 도메인 계층의 구분 없이 DTO를 직접 사용하는
                구조로 인해 중복 선언과 결합도가 높았고, 이로 인해 재사용성과
                확장성에 한계가 있었습니다. 이를 개선하기 위해{" "}
            ...
            <li>
              <h3>React 19</h3>
              <p>
                어드민 특성상 <strong>SEO보다는 사용자 인터랙션 중심</strong>의
                기능이 요구되는
                <Link
              ...
              <p>
                ...
                활용하여 주문 승인 및 배송 처리에서 <strong>낙관적 UI</strong>와
                <strong>비동기 상태 전이</strong>를 동시에 처리할 예정이고 이를
                통해 사용자에게 빠른 화면을 전달 할 수 있다고 생각합니다.
              </p>
            </li>
              ...
              <ul>
                ...
                <li>
                  ...
                  <p>
                    ...
                    작은 기능에는 빠르게 적용 가능합니다. 상태 로직과 뷰 로직이
                    분리되면서 유지보수가 쉬워졌습니다.
                  </p>
                </li>
              </ul>
              ...
              <ul>
                <li>
                  ...
                  <p>
                    ...
                    normalize 등 글로벌 스타일은 <code>globalStyle</code>을 통해
                    해당 포트폴리오 프로젝트에서 사용했습니다.
                  </p>
                </li>
                <li>
